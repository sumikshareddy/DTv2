...
<body>
<form:form action="store1" method="post">	 
 <c:forEach var="e" items="${errors}">
     ...
     <button class="profile__siri" id="toggleProfile">
      ...
      <div class="profile__form">
        ...
        <form:input path='ename' name="fieldUser" placeholder="ename"  class="input" required="true" />
   </div> 
   <div class="field">
           <label for="fieldUser" class="label" ></label>
        <form:input path='edesc' name="fieldUser" placeholder="edesc"  class="input" required="true" />
   </div>
       <div class="profile__footer">
      <button type="submit" class="btn btn-success btn-sm">addevent</button>
